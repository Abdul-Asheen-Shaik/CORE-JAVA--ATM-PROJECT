...
public class ATMOperations {
	...
	public static void main(String[] args) throws NotAOperatorException {
		...
		dataBase.put(222222221L, new AxisDebitCard(222222221L, "Asheen", 50000.0, 2222));
		dataBase.put(3333333331L, new SBIDebitCard(3333333331L, "Ayaan", 55000.0, 3333));
		dataBase.put(4444444441L, new AxisDebitCard(4444444441L, "Ayaaz", 32500.0, 4444));
		dataBase.put(5555555551L, new HDFCDebitCard(5555555551L, "Ayaat", 71000.0, 5555));
